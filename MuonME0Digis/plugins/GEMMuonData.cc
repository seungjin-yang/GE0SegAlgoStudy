#ifndef MuonTriggering_MuonME0Digis_plugins_GEMMuonData_cc
#define MuonTriggering_MuonME0Digis_plugins_GEMMuonData_cc
...
class GEMMuonData {
 public:
  ...
  typedef GEMSegmentCollection::const_iterator RecSegmentData;

  GEMMuonData(SimTrackData sim_track,
...
#endif // MuonTriggering_MuonME0Digis_plugins_GEMMuonData_h
