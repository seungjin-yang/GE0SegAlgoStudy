...
#process.pdigi_valid=cms.Sequence(process.generatorSmeared+process.genParticles+process.mix+process.simMuonME0Digis+process.simMuonME0PadDigis+process.simMuonME0PadDigiClusters+process.simMuonME0PseudoDigis+process.simMuonME0PseudoReDigis+process.addPileupInfo+process.genPUProtons+process.me0LocalReco)
process.pdigi_valid=cms.Sequence(process.mix+process.simMuonME0Digis+process.simMuonME0PseudoDigis+process.simMuonME0PseudoReDigis+process.me0LocalReco)
