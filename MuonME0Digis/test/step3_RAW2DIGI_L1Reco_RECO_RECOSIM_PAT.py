...
# with command line options: step3 --conditions auto:phase2_realistic -n 10 --era Phase2 --eventcontent FEVTDEBUGHLT,MINIAODSIM --runUnscheduled -s RAW2DIGI,L1Reco,RECO,RECOSIM,PAT --datatier GEN-SIM-RECO,MINIAODSIM --geometry Extended2023D17 --filein file:step2.root --fileout file:step3.root
