...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('TenMuExtendedPt_0_200_pythia8_cfi nevts:10'), # NOTE E to Pt
...
# So I made this cfi based on `TenMuExtendedE_0_200_pythia8_cfi_GEN_SIM.py`
...
process.generator = cms.EDFilter("Pythia8PtGun", # NOTE Pythia8EGun to Pythia8PtGun
    PGunParameters = cms.PSet(
        ...
        MaxPt = cms.double(200.0), # NOTE MaxE to MaxPt
    ...
    psethack = cms.string('Ten mu pt 0 to 200') # NOTE e to pt
)
